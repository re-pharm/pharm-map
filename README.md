...
- Next.js 14.0.1 (`Create-Next-App`을 활용한 템플릿 사용)
- Yarn 4.0.1 (`PnP` 기능 미사용)
- TypeScript
- Node.js 20
...
- `SERVICE_URL`: 현재 주소에서 테스트를 위한 값입니다. 일반적으로 로컬 서버의 경우, `https://localhost:3000` 주소로 입력하시면 됩니다.
